...
-- begin function `sakila`.`get_customer_balance`
...
-- end function `sakila`.`get_customer_balance`

-- begin function `sakila`.`inventory_in_stock`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end function `sakila`.`inventory_in_stock`

-- begin function `sakila`.`inventory_held_by_customer`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end function `sakila`.`inventory_held_by_customer`

-- begin procedure `sakila`.`rewards_report`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end procedure `sakila`.`rewards_report`

-- begin procedure `sakila`.`film_in_stock`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end procedure `sakila`.`film_in_stock`

-- begin procedure `sakila`.`film_not_in_stock`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end procedure `sakila`.`film_not_in_stock`
