...
--
-- Dumping triggers for table 'sakila'.'customer'
--

-- begin trigger `sakila`.`customer_create_date`
...
/*!50032 DROP TRIGGER IF EXISTS `customer_create_date` */;
DELIMITER ;;
/*!50003 CREATE DEFINER=`root`@`localhost` TRIGGER `customer_create_date` BEFORE INSERT ON `customer` FOR EACH ROW SET NEW.create_date = NOW() */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
-- end trigger `sakila`.`customer_create_date`
